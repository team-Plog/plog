            ...
            <View style={styles.summaryContainer}>
              <View style={styles.summaryGrid}>
                ...
                <View style={styles.summaryItem}>
                  ...
                  <Text style={styles.summaryValue}>
                    {reportData.overall.total_requests}개
                  </Text>
                </View>
                ...
                <View style={styles.summaryItem}>
                  ...
                  <Text style={styles.summaryValue}>
                    {reportData.overall.failed_requests}개
                  </Text>
                </View>
                ...
                <View style={styles.summaryItem}>
                  ...
                  <Text style={styles.summaryValue}>
                    {formatNumber(reportData.overall.error_rate.avg)}%
                  </Text>
                </View>
              </View>
            ...
            <View style={styles.metricsGrid}>
              <View style={styles.metric}>
                ...
                <Text style={styles.metricValue}>
                  {formatNumber(reportData.overall.tps.avg)}
                </Text>
              </View>
              <View style={styles.metric}>
                <Text style={styles.metricLabel}>평균 응답시간</Text>
                <Text style={styles.metricValue}>
                  {formatNumber(reportData.overall.response_time.avg)}ms
                </Text>
              </View>
              <View style={styles.metric}>
                <Text style={styles.metricLabel}>최대 응답시간</Text>
                <Text style={styles.metricValue}>
                  {formatNumber(reportData.overall.response_time.max)}ms
                </Text>
              </View>
              <View style={styles.metric}>
                <Text style={styles.metricLabel}>최소 응답시간</Text>
                <Text style={styles.metricValue}>
                  {formatNumber(reportData.overall.response_time.min)}ms
                </Text>
              </View>
              <View style={styles.metric}>
                <Text style={styles.metricLabel}>P95 응답시간</Text>
                <Text style={styles.metricValue}>
                  {formatNumber(reportData.overall.response_time.p95)}ms
                </Text>
              </View>
              <View style={styles.metric}>
                <Text style={styles.metricLabel}>테스트 지속시간</Text>
                <Text style={styles.metricValue}>
                  {formatNumber(reportData.overall.test_duration)}초
                </Text>
              </View>
            </View>
          </View>
        ...
        {reportConfig.includeScenarioBreakdown && reportData.scenarios && (
          <View style={styles.section}>
            ...
            {reportData.scenarios.map((scenario, index) => (
              <View key={scenario.scenario_history_id} style={styles.scenarioCard}>
                ...
                <View style={styles.endpointInfo}>
                  <Text>
                    {scenario.endpoint.method} {scenario.endpoint.path}
                  </Text>
                </View>
                ...
                <View style={styles.scenarioMetricsContainer}>
                  <View style={styles.scenarioMetric}>
                    <Text style={styles.scenarioMetricText}>
                      실제 TPS: {formatNumber(scenario.tps.avg)}
                    </Text>
                  </View>
                  <View style={styles.scenarioMetric}>
                    <Text style={styles.scenarioMetricText}>
                      평균 응답시간: {formatNumber(scenario.response_time.avg)}
                      ms
                    </Text>
                  </View>
                  <View style={styles.scenarioMetric}>
                    <Text style={styles.scenarioMetricText}>
                      에러율: {formatNumber(scenario.error_rate.avg)}%
                    </Text>
                  </View>
                  <View style={styles.scenarioMetric}>
                    <Text style={styles.scenarioMetricText}>
                ...
                {scenario.stages && scenario.stages.length > 0 && (
                  <View style={styles.stagesContainer}>
                    ...
                    {scenario.stages.map((stage, stageIndex) => (
                      <View key={stage.stage_history_id} style={styles.stage}>
